export const publications = [
  ...
  },
  {
    ...
    authors: "Jeffrey T. Bingham, Jeongseok Lee, Ravi N. Haksar, Jun Ueda, C. Karen Liu",
    venue: "IEEE/RSJ International Conference on Intelligent Robots and Systems, 2014",
    links: [],
    tags: ["Dynamics", "Robotics"],
  },
  {
    title: "A Discrete Mechanics-Based Recursive Algorithm for Rigid Multibody Systems",
    authors: "Jeongseok Lee, Jisoo Hong, Frank C. Park",
    venue: "Japan-Korea Joint Symposium on Dynamics and Control, 2013",
    links: [],
    tags: ["Multibody dynamics"],
  },
  {
  ...
  {
    title: "srLib: The Next Standard in Robotics Physics Engines",
    authors: "Jeongseok Lee, Frank C. Park",
    venue: "International Conference on Ubiquitous Robots and Ambient Intelligence, 2009",
    links: [],
    tags: ["Physics engine"],
  },
];
...
export const patents = [
  {
    title: "Robotic workcell for interacting with goods to person systems",
...
export const talks = ["Amazon Machine Learning Conference, invited talk, Apr 2018"];
